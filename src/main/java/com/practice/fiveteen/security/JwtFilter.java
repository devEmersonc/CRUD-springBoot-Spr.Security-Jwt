package com.practice.fiveteen.security;

import com.practice.fiveteen.exception.JwtAuthenticationException;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if(username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            if(!jwtService.validateToken(token, userDetails.getUsername())) {
                jwtAuthenticationEntryPoint.commence(request, response, new JwtAuthenticationException("Token a expirado o es inválido."));
                return;
            }
